  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex",margin:70, gap: "50px" }}>
        ...
        <Link to="/login" style={{ color: "black", textDecoration: "none",fontSize:25,color:'#0A2540'}}>Cart</Link>
        <Link to="/cart" style={{ color: "black", textDecoration: "none",fontSize:25,color:'#0A2540' }}>Login</Link>
      </div>
    </nav>
  );
}
